...
public class DataScopeAspect
{
        ...
        if (StringUtils.isNotNull(loginUser))
        {
            ...
            if (StringUtils.isNotNull(currentUser) && !currentUser.isAdmin())
            {
                ...
                dataScopeFilter(joinPoint, currentUser, controllerDataScope.deptAlias(),
                        controllerDataScope.userAlias(), controllerDataScope.roleAlias(), permission);
            }
        }
    }
     ...
     */
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias, String roleAlias, String permission)
    {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            {
                sqlString.append(StringUtils.format(" OR {}.role_id = {} ", roleAlias, user.getRoleId()));
            }
