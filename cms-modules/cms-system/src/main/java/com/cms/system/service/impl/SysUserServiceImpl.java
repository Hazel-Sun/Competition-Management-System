...
import com.cms.common.core.utils.bean.BeanValidators;
...
public class SysUserServiceImpl implements ISysUserService
{
     ...
     */
    @Override
    public List<SysUser> selectAllocatedSquadList(SysUser user)
    {
        return userMapper.selectAllocatedSquadList(user);
    }
     ...
     */
    @Override
    public List<SysUser> selectUnallocatedSquadList(SysUser user)
    {
        return userMapper.selectUnallocatedSquadList(user);
    }
